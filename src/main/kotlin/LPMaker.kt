...
class LPMaker(filname: String) {
    ...
    fun makeLP() {
        ...
        lp.obj(Obj.MAX)
        //入札作成                  　　　　　　　(財1の要求量, 財2の要求量)
        val bid00 = Bid(6.0, arrayListOf(arrayListOf(1.0, 0.0)))
        val bid01 = Bid(0.0, arrayListOf(arrayListOf(0.0, 1.0)))
        val bid02 = Bid(6.0, arrayListOf(arrayListOf(1.0, 1.0)))
        val bid10 = Bid(0.0, arrayListOf(arrayListOf(1.0, 0.0)))
        val bid11 = Bid(0.0, arrayListOf(arrayListOf(0.0, 1.0)))
        val bid12 = Bid(8.0, arrayListOf(arrayListOf(1.0, 1.0)))
        val bid20 = Bid(0.0, arrayListOf(arrayListOf(1.0, 0.0)))
        val bid21 = Bid(5.0, arrayListOf(arrayListOf(0.0, 1.0)))
        val bid22 = Bid(5.0, arrayListOf(arrayListOf(1.0, 1.0)))
        val bidder0 = Bidder()
        bidder0.add(bid00)
        bidder0.add(bid01)
        bidder0.add(bid02)
