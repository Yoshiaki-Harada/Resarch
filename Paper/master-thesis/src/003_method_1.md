...
STEP1では，\secref{make-bid}の入札を作成をする．従ってSTEP2，STEP3について次項以降で説明する．また説明に使用する記号の定義を以下に示す．
...
STEP3では前項のリソース配分を元に取引価格$trade_{i,r,j,n}$を決定する．手法Iの取引価格はSamimiらの文献を参考にした\cite{Samimi2016}．この取引価格はお互いの入札値の平均の価格から決定され，以下の式で表される．
$$
\begin{align}
