...
第3章では手法Iはパレート効率性を満たすが，耐戦略性を満たせないことを確認した．ただし参加する企業が均質化する(同じような評価値を持つ企業が増加する)と，正直な申告が支配戦略になることが確認できた．第4章では手法IIは耐戦略性を満たすが，パレート効率性を満たせないことが確認できた．しかし提供企業数が増加するとパレート効率な状態に近づくことが確認できた．また手法IIではクラウドソースドマニュファクチャリング内の利益ではるが，誰の利益にも属さない余剰利益が発生してしまう．
...
| fbudget range |      | Method I   | Method  II |
| ------------- | ---- | ---------- | ---------- |
...
[@tbl:total-profit-cost-1.0]〜[@tbl:total-profit-cost-1.5]より，手法IIの方が手法Iより総利益は高い結果となった．つまり手法Iの虚偽申告の影響により総利益の損失が手法IIの仮想的な買い手による損失より大きいことがわかった．より詳しく考察するためにパレート効率な総利益に対しする手法I，手法IIの総利益の割合を[@tbl:rate-total-profit-cost-1.0]〜[@tbl:rate-total-profit-cost-2.0]示す．
...
一番パレート効率から離れているのは[@tbl:rate-total-profit-cost-2.0]の予算の幅が2.0のときの84.36%であり，一番近づいたのは[@tbl:rate-total-profit-cost-1.0]の予算の幅が1.0のときである．手法Iは予算の幅が広いほど，またコストの幅が広いほど虚偽申告を行うのでパレート効率な状態から離れていることがわかる．また手法Iと手法IIの差はコストの幅，予算の幅が狭くなるほど近づいてはいるが，手法IIの総利益より手法Iの総利益が高くなることは本実験条件ではなかった．

また[@tbl:total-providers-profit-cost-1.0]〜[@tbl:total-providers-profit-cost-2.0]の総提供企業利益の結果と[@tbl:total-requesters-profit-cost-1.0]〜[@tbl:total-requesters-profit-cost-2.0]の総要求企業利益の結果より，虚偽申告が行われる手法Iの方が手法II総提供企業利益，総要求企業利益は高かった．これは手法IIには余剰利益が発生し提供企業と要求企業に属さない利益が発生するからである．また総提供企業利益の結果である[@tbl:total-requesters-profit-cost-1.0]〜[@tbl:total-requesters-profit-cost-2.0]において手法Iと手法IIのでは大きな差があることがわかる．これは手法Iがお互いの評価値の平均で取引を行うのでそれぞれの企業数にかかわらず虚偽申告がない場合であれば総提供企業利益と総要求企業利益が一致するからである．本実験条件は要求企業数の方が実験条件であるが手法Iでは総提供企業利益と総要求企業利益が一致するため，手法IIと大きな差が生まれた．

## まとめ

本章では手法Iと手法IIの比較を行った．手法Iの総利益に対する虚偽申告企業による損失が，手法IIの仮想的な買い手による総利益の損失より大きいことがわかった．参加企業が均質化し正直な評価値の申告が支配戦略になっていくと手法IIの総利益に近づく傾向は見られたが，本実験条件では手法IIの方が総利益の値は高いままであった．現実においては様々な企業が存在し，参加企業が均質になることは考えにくいので虚偽申告を行う企業が発生する可能性がある場合は手法IIを用いる方が良いと考える．また手法IIでは余剰利益が発生するので総提供企業利益，総要求企業利益は手法Iより低い結果となった．また手法IIではこの余剰利益の運用を考える必要がある．
